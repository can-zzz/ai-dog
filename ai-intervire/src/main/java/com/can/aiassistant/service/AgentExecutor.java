...
public class AgentExecutor {
     ...
     * 执行智能体处理流程
     */
    public void execute(com.can.aiassistant.dto.ChatRequest request, StreamResponseCallback callback) {
     ...
     * 执行预处理阶段
     */
    private ProcessedRequest executePreprocessing(com.can.aiassistant.dto.ChatRequest request, ExecutionContext context) {
        log.info("📋 执行预处理阶段");
